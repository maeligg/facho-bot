...
const interjectionFin = ['Jeanne, au secours !', 'Pétain n\'aurait pas cautionné.', 'Pétain doit se retourner dans sa tombe.', 'J\'ai honte d\'être Français.', 'Virons-les !', 'Demandez l\'avis de Faurisson pour voir.', 'Retournez manger un couscous avec Philippot.', 'Ça mérite une bonne quenelle.', 'Allez lire le dernier bouquin de Soral.', 'Allez réécouter la dernière intervention de Zemmour.', 'Nos valeurs se perdent.', 'Nos valeurs se perdent. 🐷 🍷' '#LePen2022', '#Marion2022', 'On est loin de la pudeur hélléno-chrétienne.', 'Rejoignez plutôt la vraie dissidence !', 'Encore de la novlangue journalistique !', 'Vous déshonnorez la liberté de la presse.', 'Où est passée la liberté d\'expression?', 'Le génie français se perd...', 'La révolte des peuples va arriver.', 'Il y a des coups de savate qui se perdent.', 'Où est l\'authentique journalisme?', 'Fini, l\'âge d\'or de notre civilisation...', '🇫🇷', '🔥🇫🇷'];
